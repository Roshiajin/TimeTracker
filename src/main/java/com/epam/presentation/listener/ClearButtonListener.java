...
@Component
public final class ClearButtonListener implements ActionListener {

    private static final String BUTTON_NAME = Constants.ComponentNames.B_CLEAR_FILTER;

    @Autowired
    private ListenerRegistrar listenerRegistrar;

    @Autowired
    @Qualifier("ClearSearchedController")
